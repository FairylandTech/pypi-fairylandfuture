...
class BaseEnum(Enum):
    ...
    @classmethod
    def members(cls: type[_TypeBaseEnum], exclude_enums: Sequence[str] | None = None, only_value: bool = False) -> tuple[_TypeBaseEnum, ...] | tuple[Any, ...]:
        """
    ...
    @classmethod
    def values(cls: type[_TypeBaseEnum], exclude_enums: Sequence | None = None) -> tuple[Any, ...]:
        """
